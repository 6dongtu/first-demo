  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p @click="changeDefault(item, tradeData)">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(orderItem, index) in orderInfo.detailArrayList"
          :key="orderItem.skuId"
        >
          <li>
            <img
...
import { mapState } from 'vuex'
  export default {
    ...
    computed:{
      ...
      userDefault(){
        return this.tradeData.find(item=>item.isDefault == 1) || {}
      }
    },
    methods:{
      // 点击修改默认地址
      changeDefault(item,tradeData){
